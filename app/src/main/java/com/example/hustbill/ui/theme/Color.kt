...
val transparentPrimaryColor = Color(0x00FFF6D4)
val lightCardColor = Color(0xFFFFFAEA)
val cardColor = Color(0xFFFAF1CF)
...
val grey7= Color(0xFF7A7676)
val grey8 = Color(0xEBF8EAC5)
